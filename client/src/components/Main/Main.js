...
import LinkWrapper from "../props/LinkWrapper";
      ...
      <div>
        ...
        <section className="first-hightlight-wrapper">
          <div className="container">
            ...
            <LinkWrapper learnLink="#" orderLink="#" order="Order" />
        ...
        <section className="second-hightlight-wrapper">
          <div className="container">
            ...
            <LinkWrapper learnLink="#" orderLink="#" order="Buy" />
          </div>
        </section>
              ...
              <div className="left-side-wrapper col-sm-12 col-md-6">
                <div className="left-side-container">
                  ...
                  <div className="watch-more-wrapper">
                    <a href="www.apple.com">Watch now on the Apple TV App</a>
                  </div>
                </div>
              </div>
              <div className="right-side-wrapper col-sm-12 col-md-6">
            ...
            <div className="row">
              ...
              <div className="right-side-wrapper col-sm-12 col-md-6">
                <div className="right-side-container">
                  ...
                  <LinkWrapper learnLink="#" orderLink="#" order="Apply now" />
                </div>
              </div>
            </div>
          </div>
